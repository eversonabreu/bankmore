...
namespace BankMore.CurrentAccount.Infrastructure.Database.Migrations
{
    ...
    [Migration("20250627013052_UpdateFieldIdempotencyResponse")]
    partial class UpdateFieldIdempotencyResponse
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BankMore.CurrentAccount.Domain.Entities.CurrentAccount", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("07809b83-5be5-41c3-ad65-c25cd004b438"),
                            IsActive = 1,
                            Name = "Ana",
                            Number = 1234L,
            ...
            modelBuilder.Entity("BankMore.CurrentAccount.Domain.Entities.Idempotency", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
